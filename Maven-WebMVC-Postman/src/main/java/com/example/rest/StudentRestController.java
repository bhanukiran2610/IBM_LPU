 ...
 * @RestController
 * 
 * @RequestMapping("/api") public class StudentRestController {
 * 
 ...
 * 
 * theStudents.add(new Student("Bhanu", "Kiran")); theStudents.add(new
 * Student("Surya", "Kartheek")); theStudents.add(new Student("Anil", "D"));
 * 
 * return theStudents; }
 * 
 * }
...
public class StudentRestController {
	...
	/*
	 * @ExceptionHandler public ResponseEntity<StudentResponseEntity>
	 * handleGlobalException(Exception e) { return new
	 * ResponseEntity<StudentResponseEntity>(new
	 * StudentResponseEntity(HttpStatus.BAD_REQUEST.value(),
	 * "Something went wrong! Try agin", System.currentTimeMillis()),
